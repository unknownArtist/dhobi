...
{	
	$ch = curl_init();
	$MyApplicationId = 'Rh4nveOnvwTL0eZU2iCEmcpJOBjfHPQQdQTQ2EJZ';
	$MyParseRestAPIKey = 'FbzdUbekF7MkjVi6HjkUZLykhzKiqLyiGKO04GeF';
...
function getUsers()
{
	return curl_post("https://api.parse.com/1/users", 'GET');
}
