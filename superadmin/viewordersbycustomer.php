...
<td style = 'cursor:pointer' onclick = 'sort_column(0);'>No.</td><td style = 'cursor:pointer' onclick = 'sort_column(1);'>Order No.</td><td style = 'cursor:pointer' onclick = 'sort_column(2);'>Customer E-mail Address</td><td style = 'cursor:pointer' onclick = 'sort_column(3);'>First Name</td><td style = 'cursor:pointer' onclick = 'sort_column(4);'>Last Name</td><td style = 'cursor:pointer' onclick = 'sort_column(5);'>Order Address</td><td style = 'cursor:pointer' onclick = 'sort_column(6);'>Retrival Start Date/Time</td><td style = 'cursor:pointer' onclick = 'sort_column(7);'>Retrival End Date/Time</td><td style = 'cursor:pointer' onclick = 'sort_column(8);'>Delivery Start Date/Time</td><td style = 'cursor:pointer' onclick = 'sort_column(9);'>Delivery End Date/Time</td><td style = 'cursor:pointer' onclick = 'sort_column(10);'>Personal Request</td><td style = 'cursor:pointer' onclick = 'sort_column(11);'>Progress</td><td style = 'cursor:pointer' onclick = 'sort_column(12);'>Credit Card</td><td style = 'cursor:pointer' onclick = 'sort_column(13);'>Promo Matched</td><td style = 'cursor:pointer' onclick = 'sort_column(14);'>Store Code</td>
</thead>
<tbody id = 'tbody'>
<?php 
$ct = 0;
...
this.style.display = (flag == true ? 'none' : 'inline block');
});
}
